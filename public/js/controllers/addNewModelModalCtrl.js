angular.module('kmapp')
    .controller("addNewModelModalCtrl", ["$scope", "$uibModalInstance", "projects","addModel", "Upload", "$timeout",
        "serviceData", "$http", "$q", "serviceBase",
        function ($scope, $uibModalInstance, projects,addModel, Upload, $timeout, serviceData, $http, $q, serviceBase) {
            $scope.projects = projects;
            $scope.projectName = projects[0];
            $scope.listConfig = [];
